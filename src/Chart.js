...
export default function Chart() {
  ...
  const [totalstatdata , settotalstatdata] = useState([])
  ...
  const covid19india = async ()=>{
    ...
    settotalstatdata(actda.statewise)
  }
    ...
    <React.Fragment>
      ...
      <FormControl variant="outlined" className={classes.formControl}>
        ...
        >
          ...
          {
            totalstatdata.map((stat,ndx)=>{
              return(
                <MenuItem key={ndx} value={stat.state}>{stat.state}</MenuItem>
